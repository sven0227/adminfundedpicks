...
const SearchResultItem = forwardRef(({ action, active, currentRootActionId }, ref) => {
  // Hooks
  ...
  return (
    <div
      ref={ref}
      className={classnames('flex items-center justify-between gap-2 relative plb-2 pli-4 cursor-pointer', {
