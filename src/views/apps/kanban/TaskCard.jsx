...
const TaskCard = ({ task, dispatch, column, setColumns, columns, setDrawerOpen, tasksList, setTasksList }) => {
  // States
    ...
    <>
      ...
      >
        <CardContent className='flex flex-col gap-y-2 items-start relative overflow-hidden'>
          ...
          {task.image && <img src={task.image} alt='task Image' className='is-full rounded-xl' />}
